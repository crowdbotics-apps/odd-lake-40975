"""
Django settings for odd_lake_40975 project.
...
ROOT_URLCONF = 'odd_lake_40975.urls'
...
WSGI_APPLICATION = 'odd_lake_40975.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_lake_40975 API",
    "DESCRIPTION": "API documentation for odd_lake_40975 App",
    "VERSION": "v1",
}
